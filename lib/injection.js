...
function createAlfaSubscribedComponent(store, WrappedComponent, keys, output) {
  ...
  var classHolder = _defineProperty({}, WrappedComponent.name, (_temp = _class = function (_Component) {
  ...
  if (WrappedComponent.keys) classHolder[WrappedComponent.name].keys = WrappedComponent.keys;
