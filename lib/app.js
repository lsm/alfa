...
var App = exports.App = function (_Component) {
  ...
  function App(props, context) {
    ...
    var data = props.data;
    if (data) {
      _this.store = data.isAlfaStore ? data : new _store2.default(data);
    } else {
...
App.childContextTypes = {
  alfaStore: _propTypes2.default.object.isRequired
};
function app(WrappedComponent, data) {
  return function (props) {
    return _react2.default.createElement(
      App,
      { data: data },
      (0, _react.createElement)(WrappedComponent, props)
    );
  };
}