...
exports.subscribe = exports.provide = exports.action = exports.set = exports.get = undefined;
exports.createAlfa = createAlfa;
...
function createAlfa(name) {
  function alfa(name) {
    return createAlfa(name);
  }

  if (name) alfa.name = name;
